...
class TerrainMapEnhancedConfig(ModuleConfig):
    world_frame: str = "map"
...
class TerrainMapEnhanced(Module):
    """Enhanced terrain map with z-column clearing: accumulates local terrain into a wider, slower-decaying map.

    NOTE: This is NOT a port of terrainAnalysisExt.cpp. It adds z-column clearing
    behavior and subscribes to terrain_map (output of TerrainAnalysis) rather than
    registered_scan. See TerrainMapExt for the faithful reimplementation.
    """

    config: TerrainMapEnhancedConfig

    terrain_map: In[PointCloud2]
    odometry: In[Odometry]
    terrain_map_enhanced: Out[PointCloud2]
    ...
    def _publish_loop(self) -> None:
        ...
        while self._running:
            ...
            if pts:
                ...
                self.terrain_map_enhanced.publish(
