...
def main(mjcf_path: str) -> None:
    ...
    # Inlined to avoid pulling in dimos.visualization.viser (the viser
    # viewer is in a separate PR).  Same definition as the version in
    # robot_meshes.py: g1/left_hip_pitch -> left_hip_pitch_joint.
